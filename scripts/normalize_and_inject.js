...
const anchor = '<!-- ==================== JAVASCRIPT MOTORU ==================== -->\n    <script>';
const idx = content.indexOf(anchor);
if (idx === -1) {
    console.error('Could not find anchor in HTML!');
} else {
    content = content.substring(0, idx + anchor.length) + engineCode + content.substring(idx + anchor.length);
    fs.writeFileSync('indikator_sablonu.html', content, 'utf8');
    console.log('Successfully injected indicator engine with LF line endings!');
}
