...
const targetAnchor = `    <!-- ==================== JAVASCRIPT MOTORU ==================== -->
    <script>
        const canvas = document.getElementById('glcanvas');`;

const engineCode = `    <!-- ==================== JAVASCRIPT MOTORU ==================== -->
    <script>
        // ============================================================
...
content = content.replace(targetAnchor, engineCode);

fs.writeFileSync('indikator_sablonu.html', content, 'utf8');
console.log('Successfully inserted complete indicator engine at exact anchor location!');
