...
// 1. Remove any previous broken insertions
content = content.replace(/\/\/ ============================================================\s*\/\/ 📊 TEKNİK HESAPLAMA MOTORU VE FORMÜL KÜTÜPHANESİ[\s\S]*?window\.runPineScript = function[\s\S]*?\};\n/g, '');

const scriptTag = `    <!-- ==================== JAVASCRIPT MOTORU ==================== -->
    <script>`;

const fullEngineAtTop = `    <!-- ==================== JAVASCRIPT MOTORU ==================== -->
    <script>
        // ============================================================
...
content = content.replace(scriptTag, fullEngineAtTop);

fs.writeFileSync('indikator_sablonu.html', content, 'utf8');
console.log('Successfully placed complete indicator engine right after <script> tag!');
